...
public class User implements Serializable {
  ...
  * @generated
  */
  @Column(name = "upload", nullable = true, unique = false, insertable=true, updatable=true)
  ...
  * @generated
  */
  @Column(name = "uploadDropbox", nullable = true, unique = false, insertable=true, updatable=true)
  @CronapiCloud(type = "dropbox", value="9AFYR7pXfpAAAAAAAAAABac1LcdWqqVP8RhSdokIVDIXAKbJ_Z5z6JepOLvr5794")
  
  private java.lang.String uploadDropbox;
   ...
   * @generated
   */
  public User setUpload(byte[] upload){
    this.upload = upload;
    return this;
  }
  ...
  public java.lang.String getUploadDropbox(){
    return this.uploadDropbox;
  }

  /**
   * Define uploadDropbox
   * @param uploadDropbox uploadDropbox
   * @generated
   */
  public User setUploadDropbox(java.lang.String uploadDropbox){
